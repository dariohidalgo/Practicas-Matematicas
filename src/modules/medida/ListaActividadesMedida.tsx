...
export default function ListaActividadesMedida() {
  ...
  const actividadesCompletadas = progress?.activityProgress?.medida || {}
      ...
      <div className="container mx-auto py-8 px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-xl shadow-md overflow-hidden">
            <div className="p-6">
              <h2 className="text-lg font-bold text-gray-800 mb-2">Meters to Centimeters</h2>
              <p className="text-gray-600 mb-4">Convert between meters and centimeters.</p>
              <div className="flex items-center justify-between">
                <button
                  className="bg-purple-600 text-white hover:bg-purple-700 px-4 py-2 rounded font-semibold"
                  onClick={() => navigate("/modulos/medida/actividad3")}
                >
                  Comenzar
                </button>
              </div>
